...
paperweight {
    ...
    useStandardUpstream("base") {
        url = github("PlazmaMC", "Thunderbolt")
        ref = providers.gradleProperty("baseCommit")
...
val github = "https://api.github.com/repos/PlazmaMC/Thunderbolt"
...
tasks {
    ...
    register("checkNeedsUpdate") {
        ...
        doLast {
            println(latest != project.property("baseCommit"))
        }
    }
