...
공개 서버에서 사용하고 싶다면 대신 [Plazma]를 사용하세요.
...
If you want to use it on a public server, use [Plazma] instead.
...
| Name (이름) | Support Version (지원 버전) | Downloads (다운로드) |
|:---:|:---:|:---:|
| [Sector File](https://github.com/PlazmaMC/Thunderbolt/tree/feat/sector-file) | 1.20.4 | **[Reobf Paperclip (Default)](https://github.com/PlazmaMC/Thunderbolt/releases/download/build/sector-file/latest/thunderbolt-paperclip-1.20.4-R0.1-SNAPSHOT-reobf.jar)**<br>**[Mojmap Paperclip](https://github.com/PlazmaMC/Thunderbolt/releases/download/build/sector-file/latest/thunderbolt-paperclip-1.20.4-R0.1-SNAPSHOT-mojmap.jar)**<br>**[Reobf Bundler](https://github.com/PlazmaMC/Thunderbolt/releases/download/build/sector-file/latest/thunderbolt-bundler-1.20.4-R0.1-SNAPSHOT-reobf.jar)**<br>**[Mojmap Bundler](https://github.com/PlazmaMC/Thunderbolt/releases/download/build/sector-file/latest/thunderbolt-bundler-1.20.4-R0.1-SNAPSHOT-mojmap.jar)**
